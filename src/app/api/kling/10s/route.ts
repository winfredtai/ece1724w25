...
const API_BASE_URL = 'https://api.302.ai/klingai/m2v_16_txt2video_10s';
const CREDITS_REQUIRED = 2; // Standard 10s video costs 2 credits

export async function POST(request: Request) {
  console.log('Received request for 10s standard video generation');
