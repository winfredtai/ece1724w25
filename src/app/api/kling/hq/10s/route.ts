...
const API_BASE_URL = "https://api.302.ai/klingai/m2v_16_txt2video_hq_10s";
const CREDITS_REQUIRED = 4; // HQ 10s video costs 4 credits

export async function POST(request: Request) {
  console.log("Received request for 10s high-quality video generation");
